          ...
          <div class="py-4 mx-auto text-center lg:py-3">
            <div class="content py-16 text-left">
              ...
              <form class="mt-7" action="">
                ...
                <div class="h-5 mb-3">
                  <div class="-mt-5">
                    <span v-if="nikVal" class="text-red-600">{{
                      $t('login_page__validator_email')
                    }}</span>
                  </div>
                </div>
                ...
                <div class="h-5 mb-3">
                  <div class="-mt-5">
                    <span v-if="pwVal" class="text-red-600">{{
                      $t('login_page__validator_password')
                    }}</span>
                  </div>
                </div>
...
export default {
  ...
  methods: {
    ...
    async login() {
      ...
      try {
        await this.authStore.login(data).then((response) => {
        ...
        if (error.response.data.error == 'Email atau password salah') {
          ...
          this.errorDescription = this.t.t(
            'login_page__modal_error_description',
          );
          this.showError = true;
        } else {
